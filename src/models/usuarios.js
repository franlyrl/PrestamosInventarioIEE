...
const usuarioSchema = new mongoose.Schema({
    ...
    correo_electronico: {
        ...
        trim: true,
        lowercase: true,
        match: [/^[\w-\.]+@(est\.utn\.ac\.cr|utn\.ac\.cr)$/, 'Solo se permiten correos de la UTN']
    },
    hash_contraseña: {
        type: String,
    ...
    estado: {
        ...
        default: 'inactivo' // CAMBIADO: Inicia inactivo hasta que el Admin vea el PDF
    },
