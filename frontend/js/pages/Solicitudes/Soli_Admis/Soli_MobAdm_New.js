    ...
    async aprobarSolicitud(solicitudId) {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:4000/api/solicitudes/admin-gestion/${solicitudId}`, {
                ...
                body: JSON.stringify({
                    estado: 'aprobada',
                    observacion: 'Aprobada por administrador'
                })
            });
    ...
    async entregarSolicitud(solicitudId) {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:4000/api/solicitudes/admin-gestion/${solicitudId}`, {
                ...
                body: JSON.stringify({
                    estado: 'entregado',
                    observacion: 'Entregada por administrador'
                })
            });
    ...
    async devolverSolicitud(solicitudId) {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:4000/api/solicitudes/admin-gestion/${solicitudId}`, {
                ...
                body: JSON.stringify({
                    estado: 'devuelto',
                    observacion: 'Devuelta por administrador'
                })
            });
...
// Estilos para el contenedor de solicitudes admin móvil
